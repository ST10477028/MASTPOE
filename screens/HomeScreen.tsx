...
const styles = StyleSheet.create({
  ...
  remove: { backgroundColor:c.input, paddingVertical:10, borderRadius:10, alignItems:"center", marginTop:10 },
  removeText: { color:c.text, fontWeight:"800" },
  fabs: { position:"absolute", right:20, bottom:20, flexDirection:"row", gap:12 },
  fab: { backgroundColor:c.green, paddingVertical:14, paddingHorizontal:22, borderRadius:30, elevation:6 },
